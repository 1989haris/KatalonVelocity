...
WebUI.setText(findTestObject('Object Repository/VelocityPayment/PersonalCheckPaymentEntryPage/input__address'), '')
...
WebUI.verifyTextPresent('Address is required', false)
