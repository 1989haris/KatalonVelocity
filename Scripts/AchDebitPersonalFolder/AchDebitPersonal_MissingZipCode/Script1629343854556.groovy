...
WebUI.setText(findTestObject('Object Repository/VelocityPayment/PersonalCheckPaymentEntryPage/input__zip'), '')
...
WebUI.verifyTextPresent('ZIP Code is required', false)
